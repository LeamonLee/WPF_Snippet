        ...
        static void Main(string[] args)
        {
            ...
            */
            ...
            Console.WriteLine("Turkey Index : {0}",
                aList2.IndexOf("Turkey", 0));           // search from index 0
            ...
            Console.WriteLine("aList Count: {0}", aList.Count);
            // The capacity automatically increases as items are added
            Console.WriteLine("aList Capacity: {0}", aList.Capacity);
            ...
            // superheroes.TryGetValue("Clark Kent", out string test);      // C#7.0 syntax
            string test;
