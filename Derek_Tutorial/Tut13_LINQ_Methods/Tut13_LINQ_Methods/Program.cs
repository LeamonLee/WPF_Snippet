...
namespace Tut13_LINQ_Methods
{
    class Program
    {
        // Delegate that is assigned a Lambda
        // expression
        delegate double doubleItDelegate(double val);
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Heads Count : {0}",
                flipList.Where(a => a == 1).ToList().Count());
            Console.WriteLine("Tails Count: {0}",
            ...
            foreach (var m in sNameList)
                Console.WriteLine("Array item starts with S: {0}", m);
            ...
            foreach (var item in squares)
                Console.WriteLine("square in a list: {0}", item);
            ...
            foreach (var n in sumList)
                Console.WriteLine("Add corresponding item in a list: {0} ", n);
